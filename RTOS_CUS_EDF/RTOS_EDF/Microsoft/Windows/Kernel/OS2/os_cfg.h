...
#define OS_SCHED_LOCK_EN          1u   /* Include code for Lock() and 
                                       dUnlock()                  */

#define OS_TICK_STEP_EN           1u   /* Enable tick stepping feature for uC/OS-View                  */
#define OS_TICKS_PER_SEC        100u   /* Set the number of ticks in one second                        */ //set 1 tick in 1 second
...
#define OS_TASK_STAT_EN           0u   /*     Enable (1) or Disable(0) the statistics task             */ // Task[62]
...
#define OS_TIME_TICK_HOOK_EN      1u   /*     Include code for OSTimeTickHook()                        */
                                       ...
                                       /* --------------------- TIMER MANAGEMENT --------------------- */
#define OS_TMR_EN                 0u   /* Enable (1) or Disable (0) code generation for TIMERS         */ // Task[61]
