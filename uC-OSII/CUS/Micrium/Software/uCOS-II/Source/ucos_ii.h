...
#define MAX 20
#define INFO 4
#define COMPLETION 0x01u
#define PREEMPTION 0x02u
// Output file
FILE* Output_fp;
errno_t Output_err;
...
typedef struct task_para_set {
	...
	INT16U TaskNumber;
    INT16U TaskPriority;
    INT16U ApeirodicTaskID;
    INT16U ServerUtility;
    INT16U AbsoluteDeadline;
    INT16U CalculatedDeadline;
} task_para_set;
// number of input task
int TASK_NUMBER;
// number of aperiodic task
...
// For record aperiodic task information cross functions
extern task_para_set AperiodicTaskCrossFunctionParameter[OS_MAX_TASKS];
#ifndef  OS_FALSE
#define  OS_FALSE                       0u
#endif
...
typedef struct os_tcb {
    ...
    INT32U           OSTCBArriveTime;       /* Task arrival time */
    INT32U           OSTCBExecutionTime;    /* Task execution time */
    INT32U           OSTCBCPUTime;          /* Task CPU time */
    INT32U           OSTCBNumber;           /* Number of Task finish time */
    INT32U           OSTCBPeriodic;         /* Task period */
    INT32U           OSTCBAbsoluteDeadline;
    INT32U           OSTCBCalculatedDeadline;
    INT32U           OSTCBApeirodicTaskID;
