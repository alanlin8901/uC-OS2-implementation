...
INT32U NPCSLockR2;
INT32U NPCSLockTime;
INT32U NPCSR1ReleaseTime;
INT32U NPCSR2ReleaseTime;
INT32U LockR1;
INT32U LockR2;
INT32U R1_ceiling;
INT32U R2_ceiling;
...
typedef struct os_tcb {
    ...
    INT32U           OSTCBBlockingTime;
    INT32U           OSTCBEnterR1;
    INT32U           OSTCBEnterR2;
    INT32U           OSTCBExitR1;
    INT32U           OSTCBExitR2;
    INT32U           OSTCBLockFirst;
    INT16U           OSTCBR1Lock;
    INT16U           OSTCBR1UnLock;
    INT16U           OSTCBR2Lock;
    INT16U           OSTCBR2UnLock;
    INT8U            OSTCBStat;             /* Task      status                                        */
    INT8U            OSTCBStatPend;         /* Task PEND status                                        */
    INT8U            OSTCBPrio;             /* Task priority (0 == highest)                            */
    INT8U            OSTCBOrigPrio;             /* Task priority (0 == highest)                            */
